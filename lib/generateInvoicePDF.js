  ...
  container.innerHTML = `
    ...
    <h2 class="font-semibold mb-2 border-b pb-2 text-lg">Invoice Items</h2>
     ...
     <div class="text-right pr-2 text-sm">
       ...
       ${invoiceData.cGSTInPercent > 0 ? `<p style="margin-bottom: 2px;">CGST (${invoiceData.cGSTInPercent}%): ₹${Math.round((invoiceData.subTotal * invoiceData.cGSTInPercent) / 100).toLocaleString()}</p>` : ''}
       ${invoiceData.sGSTInPercent > 0 ? `<p style="margin-bottom: 2px;">SGST (${invoiceData.sGSTInPercent}%): ₹${Math.round((invoiceData.subTotal * invoiceData.sGSTInPercent) / 100).toLocaleString()}</p>` : ''}
       ${invoiceData.iGSTInPercent > 0 ? `<p style="margin-bottom: 2px;">IGST (${invoiceData.iGSTInPercent}%): ₹${Math.round((invoiceData.subTotal * invoiceData.iGSTInPercent) / 100).toLocaleString()}</p>` : ''}
